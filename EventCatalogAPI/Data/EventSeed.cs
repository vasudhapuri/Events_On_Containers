    ...
    public static class EventSeedcs
    {
        ...
        private static IEnumerable<EachEvent> GetEvents()
        {
            return new List<EachEvent>()
            {
                ...
                new EachEvent { TypeId = 6, LocationId = 1, Description = "Get placed at your dream job", EventName = "Primier Virtual Tech", Price = 50.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/6", Address="Remote" ,Likes =2,  Date=new DateTime(2021, 08, 22, 11, 30, 00 ), Zip="98033", TicketType="Trial",AvailableSeats=500},
                ...
                new EachEvent { TypeId = 2, LocationId = 2, Description = "A pricesless vegan experience", EventName = "CookVegan", Price = 20.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/12", Address="Remote",  Likes=3,Date=new DateTime(2021, 08, 25, 09, 30, 00 ), Zip="98056",TicketType="Paid",AvailableSeats=100 },
